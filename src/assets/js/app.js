...
$(document).ready(function () {
  ...
  $(document).on("mouseleave", "#sidebar", function () {
    if ($("body").siblings().not("mini-sidebar")) {
      if (self == "in") {
        $("body").addClass("mini-sidebar");
        $(".subdrop + ul").slideUp();
      }
  ...
  // $('.mini-sidebar #sidebar-menu>ul>li').on('click mouseup mouseover', function () {
  //   $("body").removeClass('mini-sidebar')
  // })

  // $('.mini-sidebar #sidebar-menu>ul>li').on('click mousedown mouseout', function () {
  //   $("body").addClass('mini-sidebar')
  // })
